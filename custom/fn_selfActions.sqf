...
_itemC = "ItemCitrine" in magazines player;

if (_itemC) then {
if (a_select1 <0) then {a_select1 = player addAction ["Select Target", "custom\Make_lootPos.sqf", ["select"], 99];};
if (a_select2 <0) then {a_select2 = player addAction ["Tag Pos", "custom\Make_lootPos.sqf", ["tag"], 99];};
if (a_select3 <0) then {a_select3 = player addAction ["Tag zPos", "custom\Make_lootPos.sqf", ["tagzspawn"], 99];};
if (a_select4 <0) then {a_select4 = player addAction ["Tag Pile Pos", "custom\Make_lootPos.sqf", ["tagpile"], 99];};
if (a_select5 <0) then {a_select5 = player addAction ["Raise Z .1", "custom\Make_lootPos.sqf", ["up"], 99, false,false,"User17"];};
if (a_select6 <0) then {a_select6 = player addAction ["Lower Z .1", "custom\Make_lootPos.sqf", ["down"], 99,false,false,"User18"];};
if (a_select7 <0) then {a_select7 = player addAction ["Raise Z .01", "custom\Make_lootPos.sqf", ["up_small"], 99, false,false,"User19"];};
if (a_select8 <0) then {a_select8 = player addAction ["Lower Z .01", "custom\Make_lootPos.sqf", ["down_small"], 99, false,false,"User20"];};
if (a_select9 <0) then {a_select9 = player addAction ["Generate Loot", "custom\Make_lootPos.sqf", ["generateloot"], 99];};

} else {
player removeAction a_select1;
a_select1 =-1;
player removeAction a_select2;
a_select2 =-1;
player removeAction a_select3;
a_select3 =-1;
player removeAction a_select4;
a_select4 =-1;
player removeAction a_select5;
a_select5 =-1;
player removeAction a_select6;
a_select6 =-1;
player removeAction a_select7;
a_select7 =-1;
player removeAction a_select8;
a_select8 =-1;
player removeAction a_select9;
a_select9 =-1;
